...
import bannerAsset from "@/assets/politicas-sotracor-banner.png.asset.json";
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative isolate flex min-h-[92vh] items-center overflow-hidden bg-ink pt-20 text-primary-foreground">
        <img src={bannerAsset.url} alt="Bus de SOTRACOR en carretera junto al compromiso de su equipo" className="absolute inset-0 h-full w-full object-cover object-center transition-transform duration-1000 hover:scale-[1.02]" />
        ...
        <div className="relative mx-auto grid w-full max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-[1.2fr_.8fr] lg:px-8">
          <div className="max-w-3xl soft-rise">
            ...
            <h1 className="text-5xl font-black leading-[1.03] sm:text-6xl lg:text-8xl">POLITICAS<br />SOTRACOR</h1>
      ...
      <section id="compromiso" className="bg-commit py-16 text-primary-foreground">
